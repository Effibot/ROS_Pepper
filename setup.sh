...
create_missing_links "${ws}/ws/catkin_ws/src" "${CATKIN_WS}/src/"
# Create symlinks for colcon_ws
create_missing_links "${ws}/ws/colcon_ws/src" "${COLCON_WS}/src/"
# Create symlinks for bridge_ws
create_missing_links "${ws}/ws/bridge_ws/src" "${BRIDGE_WS}/src/"
